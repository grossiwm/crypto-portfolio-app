...
class CryptosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crypto" do
    assert_difference('Crypto.count') do
      post cryptos_url, params: { crypto: { amount_owned: @crypto.amount_owned, cost_per: @crypto.cost_per, symbol: @crypto.symbol, user: @crypto.user } }
    end
  ...
  test "should update crypto" do
    patch crypto_url(@crypto), params: { crypto: { amount_owned: @crypto.amount_owned, cost_per: @crypto.cost_per, symbol: @crypto.symbol, user: @crypto.user } }
