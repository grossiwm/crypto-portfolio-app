class CryptosController < ApplicationController
  ...
  before_action :set_user, only: [:new, :show, :edit, :update, :destroy, :index]
  ...
  private
    ...
    def correct_user
      if (!@user.cryptos.find_by(id: params[:id]))
        redirect_to cryptos_path, notice: "You're not authorized to edit this entry"
      end
    end
